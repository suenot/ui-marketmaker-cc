...
/**
 * Tiny round status dot — green (online), orange (warning/degraded), or red
 * (offline). Drive it from your own health-check loop via `status` (or the
 * legacy `connected` boolean). Pass `details` to reveal extra info on hover.
 */
export function ConnectionIndicator({
  ...
  return (
    ...
    >
      ...
      {details && hovering && (
        <div className="absolute bottom-full right-0 pb-2 z-10">
          <div
