...
const components = [
  ...
  { title: 'Status Bar', href: '/docs/components/status-bar', category: 'Status Bar', description: 'Floating bottom bar composing the four status badges.' },
  { title: 'Timezone Toggle', href: '/docs/components/timezone-toggle', category: 'Status Bar', description: 'Cycle UTC/Local/offset with a right-click picker.' },
  { title: 'Hide Toggle', href: '/docs/components/hide-toggle', category: 'Status Bar', description: 'Investor mode — mask sensitive labels with one click.' },
  { title: 'Server Stats', href: '/docs/components/server-stats', category: 'Status Bar', description: 'Compact Load/RAM/HDD/Net/Up health pill with tooltip.' },
  { title: 'Connection Indicator', href: '/docs/components/connection-indicator', category: 'Status Bar', description: 'Green/red wifi dot for live connection status.' },
