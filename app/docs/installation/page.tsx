...
export const metadata = {
  title: 'Installation · ui.marketmaker.cc',
  description: 'Install the @marketmaker_cc/ui component library from npm.',
}
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-lg text-muted-foreground font-light leading-relaxed mb-8">
        ...
        <code className="bg-muted px-1.5 py-0.5 rounded font-mono text-sm">@marketmaker_cc/ui</code>. Install it, wire up
      ...
      <CodeBlock language="bash" code={`npm install @marketmaker_cc/ui`} />
      ...
      <CodeBlock language="tsx" code={`import '@marketmaker_cc/ui/styles.css'`} />
...
module.exports = {
  ...
  content: [
    ...
    './node_modules/@marketmaker_cc/ui/dist/**/*.js',
      ...
      <CodeBlock
        language="tsx"
        code={`import { Button, OrderBook } from '@marketmaker_cc/ui'
...
import { OrderBook } from '@marketmaker_cc/ui/order-book'

// Lazy — only the order-book chunk is fetched on demand
import dynamic from 'next/dynamic'
const OrderBook = dynamic(() =>
  import('@marketmaker_cc/ui/order-book').then((m) => m.OrderBook),
)`}
      />
      <p className="text-muted-foreground font-light leading-relaxed mt-4 mb-4">
